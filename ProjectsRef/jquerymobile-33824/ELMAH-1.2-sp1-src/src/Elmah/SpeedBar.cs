...
namespace Elmah
{
    ...
    internal sealed class SpeedBar
    {
        ...
        public static readonly FormattedItem AdministrationPanel = new FormattedItem("Administration Panel", "jQuery Mobile Administration Panel", "/Admin"); //MDE added a link back to Administration Panel 4/5/2012
